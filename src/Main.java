...
class WriteALot implements ActionListener {
    ...
    private JPanel mnpnl;
	private ScrollablePanel txtpnl;
    ...
    public WriteALot() {
        ...
        txtpnl = new ScrollablePanel(new VerticalLayout());
		txtpnl.setScrollableWidth( ScrollablePanel.ScrollableSizeHint.FIT );
